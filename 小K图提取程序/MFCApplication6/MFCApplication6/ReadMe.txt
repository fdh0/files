...
MFCApplication6Dlg.h、MFCApplication6Dlg.cpp - 对话框
    这些文件包含 CMFCApplication6Dlg 类。此类定义应用程序的主对话框的行为。对话框模板包含在 MFCApplication6.rc 中，该文件可以在 Microsoft Visual C++ 中编辑。
