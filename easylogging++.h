...
public:
    enum {
        ...
        Fatal = 16, Verbose = 32, QA = 64, trace1 = 128, Unknown = 1010
    };

    static const unsigned int kMinValid = All;
    static const unsigned int kMaxValid = trace1;
    ...
    static unsigned int convertFromString(const std::string& levelStr) {
        ...
        if (levelStr == "trace1" || levelStr == "trace1") return Level::trace1;
...
#   endif // _ELPP_NDK
        ...
        set(Level::trace1, ConfigurationType::Format, "%datetime %level [%logger] [%func] [%loc] %log");
    }
...
#endif // _ELPP_QA_LOG
#if _ELPP_TRACE_LOG
#   define CTRACE(loggerId) _ELPP_LOG_WRITER(loggerId, easyloggingpp::Level::trace1)
#else
...
#endif // _ELPP_QA_LOG
#if _ELPP_TRACE_LOG
#   define CTRACE_IF(condition_, loggerId) _ELPP_LOG_WRITER_COND(condition_, loggerId, easyloggingpp::Level::trace1)
#else
...
#endif // _ELPP_QA_LOG
#if _ELPP_TRACE_LOG
#   define CTRACE_EVERY_N(interval_, loggerId) _ELPP_LOG_WRITER_N(interval_, loggerId, easyloggingpp::Level::trace1)
#else
